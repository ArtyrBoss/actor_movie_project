package ru.valder.spring.actor_movie;
...
public class ActorMovieProjectApplication {

    public static void main(String[] args) {
        SpringApplication.run(ActorMovieProjectApplication.class, args);
    }
    ...
    public CorsFilter corsFilter() {
        ...
        corsConfiguration.setAllowedOrigins(Arrays.asList("http://localhost:3300", "http://localhost:4200"));
